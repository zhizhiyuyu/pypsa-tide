...
def time_series(ds):
    """
    extract time serise from cutout
    :ds: cutout
    :return: time series
    """
...
def read_cutout_elevations(time_series, WL):
    return interp1d(time_series, WL)
...
def extract_tidal_signal_from_FES2014(fes_path, lat, lon, year):
    import uptide
    import datetime
    ...
    for i in np.nditer(index):
        ...
        try:
            ...
            elev[i] = 0.
    print("Input signal produced! new")
    return  interp1d(t_0d,elev), t_0d
